...
const Step2Interview = ({interviewData,onFinish}) => {
  ...
  useEffect(()=>{
    ...
    recognition.onresult = (event) => {
      const transript = event.results[event.results.length - 1][0].transcript
      ...
      <div className='w-full max-w-350 min-h-[80vh] bg-white rounded-3xl shadow-2xl border border-gray-200 flex flex-col lg:flex-row overflow-hidden'>
        ...
        <div className='w-full lg:w-[35%] bg-white flex flex-col items-center p-6 space-y-6 border-r border-gray-200'>
          ...
          <div className='w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-md p-6 space-y-5'>
            ...
            <div className='flex justify-center'><Timer timeLeft={timeleft} totalTime={currentQuestion?.timeLimit} /></div>
            <div className='h-px bg-gray-200'></div>
        ...
        <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
          ...
          {!feedback ? (<div className='flex items-center gap-4 mt-6'>
            ...
            className='mt-6 bg-emerald-50 border border-emerald-200 p-5 rounded-2xl shadow-sm'>
              ...
              <button
              onClick={handleNext}
              className='w-full bg-linear-to-r from-emerald-600 to-teal-500 text-white py-3 rounded-xl shadow-md hover:opacity-90 transition flex items-center justify-center gap-1'>Next Question <BsArrowRight size={18}/></button>
            </motion.div>
          )}
        </div>
      </div>
